...
export default function Onboarding({
  ...
  return (
    <div className="fixed z-10 inset-0 bg-black bg-opacity-50 flex items-start justify-center">
      <div className="relative md:left-[5%] md:top-[10vh] top-[15%] w-[calc(100%-30px)] md:w-[360px] flex text-[#687063] gap-3 flex-col p-5 bg-[#F6F4EE] border-[#F4F2ECFA] border-2 rounded-[24px]">
