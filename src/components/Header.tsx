...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="md:absolute text-[#687063] w-full leading-none md:top-[20%] md:left-[calc(1350/2)] md:p-3 m-auto md:shadow-sm flex-col text-left md:w-[150px] md:mb-0 mb-4 flex md:gap-3 md:border-[#F4F2ECFA] md:border-2 rounded-[24px] md:bg-[_rgba(255,255,255,0.98)]">
        <p>Сегодня</p>
